    ...
    <div class="col-lg-10 offset-lg-1 col-md-12">
        <div class="card mt-4">
            <div class="card-header border-bottom">
                <h3 class="card-title">Add New Recreation</h3>
            </div>
            <div class="card-body">
                @if( session('messages') )
                ...
                <form class="form-horizontal" action="{{ route('recreation-store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        <label for="name" class="col-md-3 form-label">Recreation Name</label>
                        <div class="col-md-9">
                            <input class="form-control" name="name" id="name" placeholder="Enter your Recreation Name" type="text" required="required">
                            @if($errors->has('name'))
                    ...
                    <div class="row mb-4">
                        <label for="accommodation_gallaries" class="col-md-3 form-label">Recreation Galleries</label>
                        <div class="col-md-9">
