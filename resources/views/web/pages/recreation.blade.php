    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-md-8 m-auto">
                <p style="text-align: justify;">This upscale resort offers indoor and outdoor games for both children and adult including large activity field such as Football and Cricket. We have also futsal where guests can play Lawn Tennis, Badminton, Basketball and Volleyball. Apart to this we have Billiard, Table Tennis, Archery. Cycling / Tandem-Cycling / Triplet-Cycling, Boating, Kids Electric-Motorcycle & Car. Gyms, 9D movie,Water Sports and so on.</p>
...
<section>
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6 animate__animated animate__fadeInLeftBig mt-3" style="animation-duration: 1.5s; animation-delay: 0.5s;">
                <!-- Thumbnail Image (Main Image) -->
                <a href="{{ asset($recreation->image) }}" data-lightbox="dining-gallery-{{ $recreation->id }}">
                    <img class="zoom-out" style="width: 100%; height:400px" src="{{ asset($recreation->image) }}" alt="Recreation Thumbnail">
                </a>

                <!-- Hidden Gallery Images for Lightbox (only shown in lightbox) -->
                @foreach($recreation->recreation_galleries as $gallery)
                <a href="{{ asset($gallery->recreation_photo) }}" data-lightbox="dining-gallery-{{ $recreation->id }}" style="display: none;">
                    <img src="{{ asset($gallery->recreation_photo) }}" alt="">
                </a>
                @endforeach

                <!-- Optional Icon Links and Description -->
                <a href="{{ asset($recreation->image) }}" class="lightBoxReaction" data-lightbox="dining-gallery-{{ $recreation->id }}">
